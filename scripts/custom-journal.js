...
class PathfinderPapersCustom extends JournalSheet {
	static get defaultOptions() {
		const options = super.defaultOptions;
		options.classes.push('pathfinder-papers-custom');
		return options;
	}
}
...
Journal.registerSheet("journals", PathfinderPapersCustom, {
	label: 'Papeis Pathfinder',
	types: ["base"],
	makeDefault: false
});
